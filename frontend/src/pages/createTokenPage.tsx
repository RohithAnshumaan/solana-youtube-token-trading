...
export default function CreateTokenPage() {
    ...
    return (
        <div
            className={`min-h-screen bg-black relative overflow-hidden ${isLoaded ? "page-transition" : ""
                }`}
        >
            {/* Background effects */}
            ...
            <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="max-w-4xl mx-auto">
                    <h1
                        className={`text-5xl font-bold gradient-text mb-8 ${isLoaded ? "slide-up" : ""
                            }`}
                    >
                        Create Your Token
                    </h1>
                    ...
                    >
                                    ...
                                    <CardContent>
                                        <div className="flex items-center space-x-6 mb-8">
                                            <div className="hover-scale">
                                                <img
                                                    src={channelData.image || "/placeholder.svg"}
                        ...
                        {step === 2 && (
                            <div className="space-y-8">
                                ...
                                <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm hover-lift card-glow fade-in">
                                    <CardHeader>
                                        ...
                                        <p className="text-gray-400">
                                            Based on your channel analytics and our algorithm
                                        </p>
                                    </CardHeader>
                                    <CardContent>
                                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div
                                    className="flex justify-center slide-up"
                                    style={{ animationDelay: "0.6s" }}
                                >
                                    <Button className="bg-white text-black hover:bg-gray-100 px-8 py-3 text-lg font-semibold btn-enhanced hover-lift btn-press ripple">
